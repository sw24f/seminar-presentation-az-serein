...
- **Introduction to UT-GLOBUS:**
    - UT-GLOBUS combines **spaceborne elevation**, **population density** and **polygon area** with **machine-learning techniques** to estimate building-level information.
...
- **LiDAR Data:** Used USGS 3DEP point cloud to derive building heights and generate nDSM by subtracting DEM from DSM.
- **Spaceborne Elevation Data:** Combined ALOS DSM, ICESat-2, GEDI, and WSF 3-D datasets to address spatial gaps and urban sprawl.
- **Population Density:** Incorporated Landscan 2020 data, showing correlation between population density and building Heights.
